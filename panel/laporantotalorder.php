...
<div class="page-heading">
    <h1 class="page-title">Laporan Total Order</h1>
    <ol class="breadcrumb">
...
<div class="page-content fade-in-up">
    <div class="ibox">
        ...
        <div class="ibox-body">
            ...
            <?php if ($showCetak): ?>
                <form method="post" action="laporantotalordercetak.php" target="_blank" class="mt-3">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Data Transaksi per Hari</div>
                </div>
                <div class="ibox-body">
                            ...
                            <tbody>
                                ...
                                while ($h = mysqli_fetch_assoc($harian)) : ?>
                                    <tr>
                                        ...
                                        <td><?= $h['total'] ?></td>
                                        <td>
                                            <a href="cetakpernota.php?tanggal=<?= $h['tanggal'] ?>" target="_blank" class="btn btn-sm btn-primary">
                                                Cetak Nota
                                            </a>
                                        </td>
                                    </tr>
